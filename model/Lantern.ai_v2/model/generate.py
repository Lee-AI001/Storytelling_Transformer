...
def infer_genre(query, label2id):
    ...
    genre_keywords = {
        ...
        "drama": ["expectations", "secrets", "fears", "weight"],
        "science fiction": ["drones", "technology", "rebellion", "spaceship", "ai", "circuits"],
        "adventure": ["storm", "captain", "treasure", "mischief"],
        "western": ["cowboy", "sheriff", "saloon"],
        "action": ["fight", "battle", "explosion", "chase"],
        "comedy": ["funny", "joke", "prank", "laugh"],
        "crime": ["detective", "murder", "heist", "thief"],
        "horror": ["ghost", "monster", "fear", "haunted"],
        "romance": ["love", "heart", "kiss", "passion"],
        "thriller": ["suspense", "danger", "mystery", "stalker"],
        "young adult": ["teen", "school", "coming-of-age", "friendship"],
        # Add more genres as needed to cover GENRES in pulling.py
    }
